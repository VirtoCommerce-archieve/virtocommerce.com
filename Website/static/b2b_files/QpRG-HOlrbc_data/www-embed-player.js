...
function ol(a,b,c){kl(a,"sendYoutubeMessage_: "+b+" "+M(c));var d={};d.type=b;c&&(d.data=c);a.f?a.f.sendMessage("urn:x-cast:com.google.youtube.mdx",d,t,v(function(){jl(this,"Failed to send message: "+b+".")},a)):jl(a,"Sending yt message without session: "+M(d))}
...
function Xn(a,b){if(2==b||9==b){var c=null;a.W&&(c=null);var d=v(a.Ge,a);c||(c=new og("//www.google.com/images/cleardot.gif"),Hg(c));Rn(c.toString(),1E4,d)}else X();Do(a,b)}
